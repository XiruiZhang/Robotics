...
public class Printer extends Thread {
  ...
  public static void printMainMenu(String state) { // a static method for drawing
    /*
	  t.clear(); // the screen at initialization
    
    t.drawString("Initiniating System", 0, 0);
    t.drawString("Rotating US Sensor", 0, 1);
    t.drawString("left = bangbang", 0, 2);
    t.drawString("right = p type", 0, 3);
    t.drawString(state, 0, 4);
    */
  }
  // a method to update LCD Screen and clear previous contents
  public static void updateStatus(String update,String distance) {
	  t.clear();
	  t.drawString("Status: "+update, 0, 0);
	  t.drawString("Distance: "+distance, 0, 1);
  }
}
